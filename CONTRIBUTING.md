...
The site is built from `docs/` and deployed from CI. User pages live at the top level, engineering reference under `docs/development/`. The API reference under `docs/reference/**` is generated — edit `scripts/gen_docs.py`, never the pages.
