"""Generated from spec/openapi.json (DeleteFileOptions). Do not edit by hand."""
...
class DeleteFileOptions(BaseModel):
    """DeleteFileOptions options for deleting files (used for other File structs below) Note: `author` and
