"""Generated from spec/openapi.json (UpdateFileOptions). Do not edit by hand."""
...
class UpdateFileOptions(BaseModel):
    """UpdateFileOptions options for updating files Note: `author` and `committer` are optional (if only one is
