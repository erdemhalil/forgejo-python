"""Generated from spec/openapi.json (CreateFileOptions). Do not edit by hand."""
...
class CreateFileOptions(BaseModel):
    """CreateFileOptions options for creating files Note: `author` and `committer` are optional (if only one is
    given, it will be used for the other, otherwise the authenticated user will be used)
    """
